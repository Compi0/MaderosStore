...
this.con = con;
    ...
    private void initComponents() {
        ...
        jPanel1.setBackground(new java.awt.Color(117, 151, 113));
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "", "Administradores", "Clientes" }));
    ...
    private void tablaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablaMouseClicked
        ...
        Object valorApe = tabla.getValueAt(tabla.getSelectedRow(), 2);
        JOptionPane.showMessageDialog(this, "Registro \n " + valorid.toString() + "\n"
                                        + valorNom.toString() + "\n" + valorApe.toString());
    }//GEN-LAST:event_tablaMouseClicked
public final void actualizaTabla(){
        DefaultTableModel modelo = admin.actualizaTablausuario();
